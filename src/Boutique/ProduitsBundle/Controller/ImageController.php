...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $images = $em->getRepository('BoutiqueProduitsBundle:Image')->findAll();
    ...
    {
        $image = new Image();
        $form = $this->createForm('Boutique\ProduitsBundle\Form\ImageType', $image);
    ...
    {
        $deleteForm = $this->createDeleteForm($image);
        $editForm = $this->createForm('Boutique\ProduitsBundle\Form\ImageType', $image);
